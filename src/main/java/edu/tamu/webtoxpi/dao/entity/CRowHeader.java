...
public class CRowHeader implements java.io.Serializable
{
	...
	public CRowHeader(int id, Integer rowtypes, String code, String name, Date registereddt, Date lastvisitdt)
	{
		this.id = id;
