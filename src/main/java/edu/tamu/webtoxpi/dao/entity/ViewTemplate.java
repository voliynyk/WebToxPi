...
public class ViewTemplate implements java.io.Serializable
{
	...
	public ViewTemplate(Integer id, Integer usersByUpdatedby, Integer usersByUserId, String code, String name, Date updateddt)
	{
		this.id = id;
