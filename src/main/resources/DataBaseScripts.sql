...
INSERT INTO USERS (LOGIN, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, REGISTEREDDT, LASTVISITDT) VALUES ('admin', '', 'admin', 'admin', 'VOLIYNYK@CVM.TAMU.EDU', CURRENT_DATE, CURRENT_DATE);
